...
The verified deployment path enables the repository's Pages site through GitHub Actions before uploading the static artifact. Repository Pages was enabled before the final verification run.
